...
final class RequestHandlers {
  ...
  private static final class LazyRequestHandlerWrapper implements SolrRequestHandler, SolrInfoMBean
  {
    ...
    public String getSourceId() {
      String rev = "$Id: RequestHandlers.java 1306137 2012-03-28 03:30:52Z dsmiley $";
      if( _handler != null ) {
    ...
    public String getSource() {
      String rev = "$URL: https://svn.apache.org/repos/asf/lucene/dev/branches/lucene_solr_3_6/solr/core/src/java/org/apache/solr/core/RequestHandlers.java $";
      if( _handler != null ) {
        rev += "\n" + _handler.getSource();
      }
      return rev;
